 ...
 */
class getDemandeMaterielRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DemandeMaterielRepository' shared autowired service.
     *
     * @return \App\Repository\DemandeMaterielRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DemandeMaterielRepository.php';

        return $container->privates['App\\Repository\\DemandeMaterielRepository'] = new \App\Repository\DemandeMaterielRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
